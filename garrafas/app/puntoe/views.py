...
from puntoe.forms import PuntoeForm
...
class PuntoeListView(ListView):
    model = Puntoe
    template_name = 'puntoe/puntoe_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Lista de Puntos de Encuentro'
        # context['create_url'] = reverse_lazy('puntoe:puntoe_add')
        print(reverse_lazy('puntoe:puntoe_list'))
        return context
